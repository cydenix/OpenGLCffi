...
@params('location', 'x', 'y', api='gles3')
def glUniform2i64NV(location, x, y):
	pass


@params('location', 'x', 'y', 'z', api='gles3')
def glUniform3i64NV(location, x, y, z):
	pass


@params('location', 'x', 'y', 'z', 'w', api='gles3')
...
@params('program', 'location', 'x', api='gles3')
def glProgramUniform1i64NV(program, location, x):
	pass


@params('program', 'location', 'x', 'y', api='gles3')
def glProgramUniform2i64NV(program, location, x, y):
	pass


@params('program', 'location', 'x', 'y', 'z', api='gles3')
def glProgramUniform3i64NV(program, location, x, y, z):
	pass


@params('program', 'location', 'x', 'y', 'z', 'w', api='gles3')
