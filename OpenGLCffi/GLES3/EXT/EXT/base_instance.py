...
@params('mode', 'first', 'count', 'instancecount', 'baseinstance', api='gles3')
def glDrawArraysInstancedBaseInstanceEXT(mode, first, count, instancecount, baseinstance):
	pass


@params('mode', 'count', 'type', 'indices', 'instancecount', 'baseinstance', api='gles3')
def glDrawElementsInstancedBaseInstanceEXT(mode, count, type, indices, instancecount, baseinstance):
	pass


@params('mode', 'count', 'type', 'indices', 'instancecount', 'basevertex', 'baseinstance', api='gles3')
