...
@params('textures', 'maxTextures', 'numTextures', api='gles3')
def glExtGetTexturesQCOM(textures, maxTextures, numTextures):
	pass


@params('buffers', 'maxBuffers', 'numBuffers', api='gles3')
def glExtGetBuffersQCOM(buffers, maxBuffers, numBuffers):
	pass


@params('renderbuffers', 'maxRenderbuffers', 'numRenderbuffers', api='gles3')
def glExtGetRenderbuffersQCOM(renderbuffers, maxRenderbuffers, numRenderbuffers):
	pass


@params('framebuffers', 'maxFramebuffers', 'numFramebuffers', api='gles3')
def glExtGetFramebuffersQCOM(framebuffers, maxFramebuffers, numFramebuffers):
	pass


@params('texture', 'face', 'level', 'pname', 'params', api='gles3')
...
@params('target', 'level', 'xoffset', 'yoffset', 'zoffset', 'width', 'height', 'depth', 'format', 'type', 'texels', api='gles3')
def glExtGetTexSubImageQCOM(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, texels):
	pass


@params('target', 'params', api='gles3')
