...
@params('buffers', 'maxBuffers', 'numBuffers', api='gles2')
def glExtGetBuffersQCOM(buffers, maxBuffers, numBuffers):
	pass


@params('renderbuffers', 'maxRenderbuffers', 'numRenderbuffers', api='gles2')
def glExtGetRenderbuffersQCOM(renderbuffers, maxRenderbuffers, numRenderbuffers):
	pass


@params('framebuffers', 'maxFramebuffers', 'numFramebuffers', api='gles2')
def glExtGetFramebuffersQCOM(framebuffers, maxFramebuffers, numFramebuffers):
	pass


@params('texture', 'face', 'level', 'pname', 'params', api='gles2')
...
@params('target', 'level', 'xoffset', 'yoffset', 'zoffset', 'width', 'height', 'depth', 'format', 'type', 'texels', api='gles2')
def glExtGetTexSubImageQCOM(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, texels):
	pass


@params('target', 'params', api='gles2')
