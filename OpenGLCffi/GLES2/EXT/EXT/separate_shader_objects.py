...
@params(api='gles2', prms=['type', 'program'])
...
@params(api='gles2', prms=['type', 'string'])
def glCreateShaderProgramEXT(type, string):
	pass


@params(api='gles2', prms=['pipeline', 'program'])
def glActiveShaderProgramEXT(pipeline, program):
	pass


@params(api='gles2', prms=['pipeline'])
def glBindProgramPipelineEXT(pipeline):
	pass


@params(api='gles2', prms=['type', 'count', 'strings'])
def glCreateShaderProgramvEXT(type, count, strings):
	pass


@params(api='gles2', prms=['n', 'pipelines'])
...
@params(api='gles2', prms=['pipeline', 'bufSize', 'length', 'infoLog'])
def glGetProgramPipelineInfoLogEXT(pipeline, bufSize, length):
	pass


@params(api='gles2', prms=['pipeline', 'pname', 'params'])
...
@params(api='gles2', prms=['program', 'pname', 'value'])
def glProgramParameteriEXT(program, pname, value):
	pass


@params(api='gles2', prms=['program', 'location', 'v0'])
def glProgramUniform1fEXT(program, location, v0):
	pass


@params(api='gles2', prms=['program', 'location', 'count', 'value'])
...
@params(api='gles2', prms=['program', 'location', 'v0', 'v1'])
...
@params(api='gles2', prms=['program', 'location', 'v0', 'v1', 'v2'])
...
@params(api='gles2', prms=['program', 'location', 'v0', 'v1', 'v2', 'v3'])
...
@params(api='gles2', prms=['program', 'location', 'count', 'transpose', 'value'])
...
@params(api='gles2', prms=['pipeline', 'stages', 'program'])
