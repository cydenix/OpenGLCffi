...
@params(api='gles2', prms=['location', 'x'])
def glUniform1i64NV(location, x):
	pass


@params(api='gles2', prms=['location', 'x', 'y'])
def glUniform2i64NV(location, x, y):
	pass


@params(api='gles2', prms=['location', 'x', 'y', 'z'])
def glUniform3i64NV(location, x, y, z):
	pass


@params(api='gles2', prms=['location', 'x', 'y', 'z', 'w'])
...
@params(api='gles2', prms=['program', 'location', 'x'])
def glProgramUniform1i64NV(program, location, x):
	pass


@params(api='gles2', prms=['program', 'location', 'x', 'y'])
def glProgramUniform2i64NV(program, location, x, y):
	pass


@params(api='gles2', prms=['program', 'location', 'x', 'y', 'z'])
def glProgramUniform3i64NV(program, location, x, y, z):
	pass


@params(api='gles2', prms=['program', 'location', 'x', 'y', 'z', 'w'])
